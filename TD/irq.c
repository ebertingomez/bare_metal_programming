...
MAKE_DEFAULT_HANDLER(BusFault_IRQHandler);
MAKE_DEFAULT_HANDLER(UsageFault_IRQHandler);
MAKE_DEFAULT_HANDLER(SVCall_IRQHandler);
...
static void __attribute__((aligned(512))) * vector_table[] = {
    ...
    _start,                        /* Reset handler */
                                   /******  Cortex-M4 Processor Exceptions Numbers ****************************************************************/
    NonMaskableInt_IRQHandler,     /*!< 2 Cortex-M4 Non Maskable Interrupt                                */
    HardFault_IRQHandler,          /*!< 3 Cortex-M4 Hard Fault Interrupt                                  */
    MemoryManagement_IRQHandler,   /*!< 4 Cortex-M4 Memory Management Interrupt                           */
    BusFault_IRQHandler,           /*!< 5 Cortex-M4 Bus Fault Interrupt                                   */
    0,                             /* Reserved */
    0,                             /* Reserved */
    0,                             /* Reserved */
    0,                             /* Reserved */
    UsageFault_IRQHandler,         /*!< 6 Cortex-M4 Usage Fault Interrupt                                 */
    SVCall_IRQHandler,             /*!< 11 Cortex-M4 SV Call Interrupt                                    */
    0,                             /* Reserved */
    0,                             /* Reserved */
    PendSV_IRQHandler,             /*!< 14 Cortex-M4 Pend SV Interrupt                                    */
    SysTick_IRQHandler,            /*!< 15 Cortex-M4 System Tick Interrupt                                */
                                   /******  STM32 specific Interrupt Numbers **********************************************************************/
